        ...
        <div class="swiper-slide">
            <div class="relative">
                <div class="w-full h-[510px] object-cover object-center bg-black/90 filter brightness-[90%]">
                    <video src="{{ asset('images/banner-car-care.mp4') }}" muted autoplay loop class="w-full"></video>
                </div>
                ...
                <div class="absolute top-0 left-0 w-full px-7" data-swiper-parallax-duration="2500" data-swiper-parallax-y="-300">
                    <div class="relative container md:w-[89%] h-[350px] md:h-[500px] flex flex-col justify-center gap-5 mx-auto font-poppins font-medium leading-[1.5]">
                        ...
                        <div class="mt-10">
                            <a href="{{ route('car_care.product', ['language' => app()->getLocale(), 'model' => 'solvent-based', 'type' => 'aerosol']) }}" class="bg-sky-500 py-3.5 px-10 text-white rounded-lg transition duration-150 ease-in hover:bg-sky-600">See Product</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container md:w-[89%] mx-auto px-4 py-20">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 place-items-center gap-4 mt-20 md:w-[80%] mx-auto">
        <div class="text-center">
            <div class="border border-gray-700 p-4 w-[145px] md:w-[245px] h-[145px] md:h-[245px]">
                <a href="{{ route('car_care.product', ['language' => app()->getLocale(), 'model' => 'solvent-based', 'type' => 'aerosol']) }}">
                    <img data-src="{{ asset('images/car-care-4.png') }}" alt="image" class="lazy h-[100px] md:h-[200px] mx-auto brightness-[90%]">
                </a>
            </div>
            <h4 class="text-md font-medium mt-3">Solvent Based</h4>
        </div>
        <div class="text-center">
            <div class="border border-gray-700 p-4 w-[145px] md:w-[245px] h-[145px] md:h-[245px]">
                <a href="{{ route('car_care.product', ['language' => app()->getLocale(), 'model' => 'oil-based', 'type' => 'aerosol']) }}">
                    <img data-src="{{ asset('images/car-care-2.png') }}" alt="image" class="lazy h-[100px] md:h-[200px] mx-auto brightness-[90%]">
                </a>
            </div>
            <h4 class="text-md font-medium mt-3">Oil Based</h4>
        </div>
        <div class="text-center">
            <div class="border border-gray-700 p-4 w-[145px] md:w-[245px] h-[145px] md:h-[245px]">
                <a href="{{ route('car_care.product', ['language' => app()->getLocale(), 'model' => 'water-based', 'type' => 'aerosol']) }}">
                    <img data-src="{{ asset('images/car-care-3.png') }}" alt="image" class="lazy h-[100px] md:h-[200px] mx-auto brightness-[90%]">
                </a>
            </div>
            <h4 class="text-md font-medium mt-3">Water Based</h4>
        </div>
    </div>
